...
In the `server/controllers/movies.mjs` file, you will notice a method called `findMoviesWithRegex`. This is where we'll add the code to query the collection with a regex.
